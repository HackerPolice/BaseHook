...
static bool Init() { // checking for if we can create a window or not
	...
	windowClass.lpszClassName = UniText("BackHook");
	windowClass.hIconSm = NULL;

	RegisterClassEx(&windowClass);

	HWND window = CreateWindow(UniText("BackHook"), UniText("DirectX Window"), WS_OVERLAPPEDWINDOW, 0, 0, 100, 100, NULL, NULL, windowClass.hInstance, NULL);
	HMODULE libD3D9;
